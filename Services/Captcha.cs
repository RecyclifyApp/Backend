...
namespace Backend.Services
{
    public class Captcha
    {
        ...
        public Captcha(HttpClient httpClient)
        {
            ...
            _recaptchaSecretKey = Environment.GetEnvironmentVariable("CAPTCHA_SECRET_KEY") 
                                  ?? throw new InvalidOperationException("CAPTCHA_SECRET_KEY is not set in .env file.");
        }
